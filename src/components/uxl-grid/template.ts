...
export const template = (props: UxlGrid) => html`
  ...
  ${props.isFormatGrid ?
        html`
            ...
            exportparts="header, header__cell-1, header__cell-2, header__cell-3, header__cell-4, header__cell-5, header__cell-6, header__cell-7, content, content__row, content__cell, content__cell-1, content__cell-2, content__cell-3, content__cell-4, content__cell-5, content__cell-6"></format-grid>` :
		html `
